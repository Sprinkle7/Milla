                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>Lost</b></h4>
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php if (!empty($Losts)) {
                                            foreach ($Losts as $EachLost) {
                                            echo '<tr>
                                                    <td>'.$EachLost->title.'</td>
                                                    <td>'.$EachLost->desc.'</td>
                                                    <td>'.$EachLost->long.'</td>
                                                    <td>'.$EachLost->lat.'</td>
                                                    <td>'.$EachLost->address.'</td>
                                                    <td><a href="#" class="btn btn-default">Show Details</a></td>
                                                  </tr>';   
                                            }
                                        }?>
                                        </tbody>
