...
$(document).ready(function () {
  ...
  //////Autorization//////
  $('.log_btns').on('click', function () {
      "use strict";
    $('#autoriz').removeClass("none");
  })
  $('#close').on('click', function () {
      "use strict";
    $('#autoriz').addClass("none");
  })
  ...
  $('#signup').on('click', function () {
      "use strict";
    $('#thannkyou').removeClass("none");
  })
  $('#closed').on('click', function () {
      "use strict";
    $('#thannkyou').addClass("none");
  });
  ...
  // 
   $('.claim').on('click', function () {
      "use strict";
    $('#claims').removeClass("none");
  })
  $('#c').on('click', function () {
      "use strict";
    $('#claims').addClass("none");
  });
   $('#calm').on('click', function () {
      "use strict";
    $('#claims').addClass("none");
    $('#claimti').removeClass("none");
  })
  $('#loot').on('click', function () {
      "use strict";
    $('#claimti').addClass("none");
  });
   //////Found Something//////
  $('.log_found').on('click', function () {
      "use strict";
    $('#foundsomething').removeClass("none");
  })
  $('#Unopen').on('click', function () {
      "use strict";
    $('#foundsomething').addClass("none");
  })
  $('#asdsdasdsadsa').on('click', function () {
      "use strict";
    $('#foundsomething').addClass("none");
  })
  // thanks
  $('#asdsdasdsadsa').on('click', function () {
      "use strict";
    $('#Thanx').removeClass("none");
  })
  $('#Thanxby').on('click', function () {
      "use strict";
    $('#Thanx').addClass("none");
  });
